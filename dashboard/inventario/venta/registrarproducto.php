...
if (isset($_POST["submit"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["archivo"]["tmp_name"], $target_file)) {
            $sql = "INSERT INTO inventario_venta(nombreproducto,descripcionproducto,codigoproducto,imgcodigo,idbodega,idproveedor,precio_compra,precio_venta,stock,rutaimg) VALUES 
            ('$nombreproducto','$descripcionproducto','$codigoproducto','$rutacodigo','$ubicacionproducto','$datoproveedor','$preciocompra','$precioventa','$stockproducto','$target_file')";
